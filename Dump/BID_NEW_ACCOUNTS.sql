...
CREATE TABLE `ACCOUNTS` (
  ...
  KEY `FK_ACCOUNTS3` (`ID_ACCESS_LEVEL`),
  CONSTRAINT `FK_ACCOUNTS2` FOREIGN KEY (`ID_BANK`) REFERENCES `C_BANKS` (`ID_BANK`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_ACCOUNTS3` FOREIGN KEY (`ID_ACCESS_LEVEL`) REFERENCES `ACCESS_LEVEL` (`ID_ACCESS_LEVEL`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `ACCOUNTS` VALUES (1,1,1,'876786876876','76876876876876',1),(2,1,2,'7868687687','6876786876876',1);
