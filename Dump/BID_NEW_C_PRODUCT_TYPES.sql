...
CREATE TABLE `C_PRODUCT_TYPES` (
  ...
  KEY `FK_PRODUCT_TYPES_2_idx` (`ID_PROVIDER`),
  CONSTRAINT `FKn517kydlwl0g4wgq0aei5nwv0` FOREIGN KEY (`ID_PROVIDER`) REFERENCES `PROVIDERS` (`ID_PROVIDER`),
  CONSTRAINT `FK5gg54ttyyp8hysqsvw8wqcpby` FOREIGN KEY (`ID_BUDGET_SUBCATEGORY`) REFERENCES `C_BUDGET_SUBCATEGORIES` (`ID_BUDGET_SUBCATEGORY`),
  ...
  CONSTRAINT `FK_PRODUCT_TYPES_2` FOREIGN KEY (`ID_PROVIDER`) REFERENCES `PROVIDERS` (`ID_PROVIDER`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `C_PRODUCT_TYPES` VALUES (1,'Tecnologia',1,NULL,1),(2,'Muebles',1,NULL,1),(3,'Limpieza',1,NULL,1),(4,'Transporte',1,NULL,1),(5,'Estancia',1,NULL,1),(6,'Consumibles',1,NULL,1),(7,'Inmuebles',1,NULL,1),(8,'Luz',15,NULL,1),(9,'Telefonia Fija',17,NULL,1),(10,'Telefonia Movil',18,NULL,1),(11,'Internet',19,NULL,1),(12,'Seguridad',16,NULL,1);
