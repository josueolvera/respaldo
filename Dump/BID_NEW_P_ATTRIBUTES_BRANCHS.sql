...
--
-- Dumping data for table `P_ATTRIBUTES_BRANCHS`
--

LOCK TABLES `P_ATTRIBUTES_BRANCHS` WRITE;
/*!40000 ALTER TABLE `P_ATTRIBUTES_BRANCHS` DISABLE KEYS */;
/*!40000 ALTER TABLE `P_ATTRIBUTES_BRANCHS` ENABLE KEYS */;
UNLOCK TABLES;
