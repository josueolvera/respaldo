...
CREATE TABLE `TABLES_FIELD` (
  ...
  KEY `FK28naay5mn6we7omxtfgrtesbm` (`ID_FIELD`),
  KEY `FKa29l5a6iarr9umsnec23rgxka` (`ID_TABLE`),
  CONSTRAINT `FKa29l5a6iarr9umsnec23rgxka` FOREIGN KEY (`ID_TABLE`) REFERENCES `C_TABLES` (`ID_TABLE`),
  CONSTRAINT `FK28naay5mn6we7omxtfgrtesbm` FOREIGN KEY (`ID_FIELD`) REFERENCES `C_FIELDS` (`ID_FIELD`),
