...
--
-- Dumping data for table `C_ACCOUNTS_PAYABLE_STATUS`
--

LOCK TABLES `C_ACCOUNTS_PAYABLE_STATUS` WRITE;
/*!40000 ALTER TABLE `C_ACCOUNTS_PAYABLE_STATUS` DISABLE KEYS */;
INSERT INTO `C_ACCOUNTS_PAYABLE_STATUS` VALUES (1,'Inactiva',1),(2,'Pendiente',2),(3,'Finalizada',3),(4,'Cancelada',4);
/*!40000 ALTER TABLE `C_ACCOUNTS_PAYABLE_STATUS` ENABLE KEYS */;
UNLOCK TABLES;
