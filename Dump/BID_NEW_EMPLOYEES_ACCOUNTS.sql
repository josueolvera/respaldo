...
CREATE TABLE `EMPLOYEES_ACCOUNTS` (
  ...
  KEY `FK_EMPLOYEES_ACCOUNTS2` (`ID_BANK`),
  CONSTRAINT `FK_EMPLOYEES_ACCOUNTS2` FOREIGN KEY (`ID_BANK`) REFERENCES `C_BANKS` (`ID_BANK`) ON DELETE NO ACTION ON UPDATE NO ACTION
