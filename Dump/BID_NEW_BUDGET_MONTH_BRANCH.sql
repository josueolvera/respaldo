...
CREATE TABLE `BUDGET_MONTH_BRANCH` (
  ...
  `EXPENDED_AMOUTN` decimal(14,2) NOT NULL DEFAULT '0.00',
  ...
  KEY `FK_BUDGET_MONTH_3_idx` (`ID_BRANCH`),
  ...
  CONSTRAINT `FK_BUDGET_MONTH3` FOREIGN KEY (`ID_BRANCH`) REFERENCES `C_BRANCHS` (`ID_BRANCH`) ON DELETE NO ACTION ON UPDATE NO ACTION,
