...
--
-- Dumping data for table `ADMON_ACCOUNTS`
--

LOCK TABLES `ADMON_ACCOUNTS` WRITE;
/*!40000 ALTER TABLE `ADMON_ACCOUNTS` DISABLE KEYS */;
/*!40000 ALTER TABLE `ADMON_ACCOUNTS` ENABLE KEYS */;
UNLOCK TABLES;
