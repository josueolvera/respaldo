...
CREATE TABLE `PRODUCT_TYPES_PRODUCT` (
  ...
  KEY `FK_PRODUCT_TYPES_PRODUCT_3_idx` (`ID_ACCESS_LEVEL`),
  ...
  CONSTRAINT `FK_PRODUCT_TYPES_PRODUCT_3` FOREIGN KEY (`ID_ACCESS_LEVEL`) REFERENCES `ACCESS_LEVEL` (`ID_ACCESS_LEVEL`) ON DELETE NO ACTION ON UPDATE NO ACTION
