...
--
-- Table structure for table `AUTHORIZATION_TREE_RULES`
--

DROP TABLE IF EXISTS `AUTHORIZATION_TREE_RULES`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `AUTHORIZATION_TREE_RULES` (
  `ID_RULE` int(11) NOT NULL AUTO_INCREMENT,
  `RULE_NAME` varchar(100) NOT NULL,
  `RULE_CODE` longtext NOT NULL,
  PRIMARY KEY (`ID_RULE`),
