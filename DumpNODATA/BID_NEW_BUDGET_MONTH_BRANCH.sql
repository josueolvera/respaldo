...
CREATE TABLE `BUDGET_MONTH_BRANCH` (
  ...
  KEY `FKisggisns2tpcp5qi2bg4xln4n` (`ID_MONTH`),
  CONSTRAINT `FKisggisns2tpcp5qi2bg4xln4n` FOREIGN KEY (`ID_MONTH`) REFERENCES `C_MONTHS` (`ID_MONTH`),
  CONSTRAINT `FK54cgabg5qhnjw8n0fgk4i9htq` FOREIGN KEY (`ID_BUDGET`) REFERENCES `BUDGETS` (`ID_BUDGET`),
  CONSTRAINT `FKpgt8wehsclwmqe3w1nj4m818x` FOREIGN KEY (`ID_CURRENCY`) REFERENCES `C_CURRENCIES` (`ID_CURRENCY`),
  CONSTRAINT `FKtl47pxsxt1iodp5h150iibws6` FOREIGN KEY (`ID_DW_ENTERPRISE`) REFERENCES `DW_ENTERPRISES` (`ID_DW_ENTERPRISE`),
...
-- Dump completed on 2016-02-17 17:43:32
