...
CREATE TABLE `EMAIL_TEMPLATES` (
  ...
  `SENDER_ADDRESS` varchar(2048) NOT NULL,
  `SENDER_NAME` varchar(2048) NOT NULL,
  `EMAIL_SUBJECT` text,
  `MESSAGE_TITLE` varchar(300) DEFAULT NULL,
  `MESSAGE` text,
  `SMTP_USER` varchar(1024) NOT NULL,
  `SMTP_PASSWORD` varchar(1024) NOT NULL,
  `SMTP_HOST` varchar(1024) NOT NULL,
