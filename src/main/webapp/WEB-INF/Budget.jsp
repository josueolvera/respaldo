            ...
            var vm= new Vue({
                ...
                methods:
                {
                    getUserInSession: function() {
                        this.$http.get(ROOT_URL + "/user")
                                .success(function (data) {
                                    this.user = data;
                                    this.getCBudgets(this.user.idUser);
                                })
                                .error(function(data) {
                                    showAlert("Ha habido un error al obtener al usuario en sesion",{type:3});
                                });
                    },
                    getCBudgets : function (idUser) {
                        this.$http.get(ROOT_URL + '/users-budgets/user/' + idUser)
                                .success(function (data) {
                                    this.cBudgets = data;
                                })
                                .error(function (data) {
                    ...
                    setYears : function () {
                        ...
                        this.minYear = this.currentYear - 3;
...
//                        this.getBudgetsByDistributorAndArea();
                    ...
                    getBudgetByCBudget: function () {
                        this.$http.get(ROOT_URL + '/budgets/c-budget/' + this.cBudget.idCBudget)
                                .success(function (data) {
                                    var self = this;
                                    this.contenido = data;
                                    this.budgets = data;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <form v-on:submit.prevent="searchBudget">
                        <div class="col-md-2">
                            <label>¿?</label>
                            <select v-model="cBudget" class="form-control" @change="">
                                <option v-for="cBudget in cBudgets" :value="cBudget">{{cBudget.name}}</option>
                            </select>
                        </div>
                        <%--<div class="col-md-2">--%>
                            <%--<label>Area</label>--%>
                        ...
                        <div class="col-md-2">
                            <label>Año</label>
                            <select v-model="selected.year" class="form-control">
