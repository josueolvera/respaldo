...
<t:template pageTitle="BID Group: Solicitud">
    ...
    <jsp:body>
        <div id="content">
            ...
            <div class="row">
                <div class="col-md-5">
                    <h3>Solicitud fuera de presupuesto</h3>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        <td class="col-md-3">product not value</td>
                        <td class="col-md-1"><input class="form-control" maxlength="3" type="text"
                                                    ...
                                                    placeholder="0" v-model="product.quantity" required
                ...
                <div class="col-md-12">
                    <div class="row">
                        <table class="table table-striped">
                            <tr class="col-md-12">
                                <td class="col-md-2"><b>Cotización</b></td>
                            ...
                            <tr class="col-md-12">
                                <td class="col-md-2">Justificación</td>
                                <td class="col-md-6">
                                    <p>lorem imsum a simplemtet lorem imsum a simplemtet
                                        lorem imsum a simplemtet  lorem imsum a simplemtet</p>
                                </td>
                            </tr>
                        </table>
                    </div><br>
                    <div style="margin-left: 76%">
                        <button @click="showModalSolicitud()" class="btn btn-success">Autorizar</button>
                        <button @click="()" class="btn btn-danger">Rechazar</button>
            ...
            <div class="modal-dialog modal-ms">
                <div class="modal-content modal-ms">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <p align="center" style="font-size: 16px">La solicitud será enviada a compras.</p>
                            </div>
                        </div>
                    </div>
                    <br>
