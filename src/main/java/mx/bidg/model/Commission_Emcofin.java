...
@Entity
@DynamicUpdate
@Table(name = "COMMISION_EMCOFIN")
@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "_id")
public class Commission_Emcofin implements Serializable {
    ...
    public Commission_Emcofin() {
    }

    public Commission_Emcofin(Integer idComEmcofin) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Commission_Emcofin)) {
            return false;
        }
        Commission_Emcofin other = (Commission_Emcofin) object;
