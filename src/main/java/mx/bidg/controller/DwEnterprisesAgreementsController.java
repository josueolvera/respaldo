 ...
 */
@Controller
@RequestMapping("enterprises-agreements")
public class DwEnterprisesAgreementsController {
    ...
    public ResponseEntity<String> findAll() throws IOException{
       List<DwEnterprisesAgreements> dwEnterprisesAgreements = dwEnterprisesAgreementsService.findAll();
