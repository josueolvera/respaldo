...
public class TransactionsController {
    ...
    @RequestMapping(value = "/report/accounts-payable", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<String> reportPayAccount(@RequestBody String data, HttpServletResponse response) throws IOException {
        JsonNode node = mapper.readTree(data);
