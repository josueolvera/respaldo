...
public class BudgetYearConceptController {
    ...
    public ResponseEntity<String> copyBudget(
        ...
        if (a != null){
            ...
            AuthorizationCostCenter authorizationCostCenter = new AuthorizationCostCenter();
            authorizationCostCenter.setYear(yearToCopy);
            authorizationCostCenter.setcCostCenterStatus(CCostCenterStatus.INICIAL);
            authorizationCostCenter.setCostCenter(new CCostCenter(idCostCenter));
            authorizationCostCenter.setUsers(user);
            authorizationCostCenterService.save(authorizationCostCenter);
