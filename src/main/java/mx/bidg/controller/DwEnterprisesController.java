...
public class DwEnterprisesController {
    ...
    public @ResponseBody ResponseEntity<String> getDwEnterprises(
        ...
        return new ResponseEntity<>(mapper.writerWithView(JsonViews.Embedded.class).writeValueAsString(dwEnterprises), HttpStatus.OK);
    }
    ...
    public @ResponseBody ResponseEntity<String> getByGroupArea(@PathVariable int idGroup, @PathVariable int idArea) throws Exception {
        ...
        return new ResponseEntity<>(mapper.writerWithView(JsonViews.IdsEnterprises.class).writeValueAsString(list), HttpStatus.OK);
    }
    ...
    public @ResponseBody ResponseEntity<String> getByIdUser(@PathVariable int idUser) throws JsonProcessingException {
        ...
        return new ResponseEntity<>(mapper.writerWithView(JsonViews.Root.class).writeValueAsString(dw), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> getHierarchy() throws IOException {
        ...
        return new ResponseEntity<>(
                mapper.writerWithView(JsonViews.Embedded.class).writeValueAsString(hierarchy),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<String> getDRB(@PathVariable Integer idDistributor,@PathVariable Integer idRegion, @PathVariable Integer idBranch)throws IOException{
        ...
        return new ResponseEntity<>(mapper.writerWithView(JsonViews.Embedded.class).writeValueAsString(dwEnterprise),HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> getBranchByDistributor(@PathVariable Integer idDistributor) throws IOException{
        ...
        return new ResponseEntity<>(mapper.writerWithView(JsonViews.Embedded.class).writeValueAsString(branchs), HttpStatus.OK);
    }
