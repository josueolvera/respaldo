...
public class BuildPdfMrPay {
    ...
    public void createPdf(String filename, PdfAternaPojo aternaPojo)
        ...
        paragraph4.add("SR.PAGO - CANAL DE PAGO");
        ...
        Image image = Image.getInstance("/run/media/Centos/Storage/SCOPA/imagenes/logoMrPay.jpg");
        image.scalePercent(8.5f);
        ...
        cProducto.setBackgroundColor(BaseColor.GRAY);
        ...
        cEmision.setBackgroundColor(BaseColor.GRAY);
        ...
        cMes.setBackgroundColor(BaseColor.GRAY);
        ...
        cSubtotal.setBackgroundColor(BaseColor.GRAY);
        ...
        cIva.setBackgroundColor(BaseColor.GRAY);
        ...
        cTotal.setBackgroundColor(BaseColor.GRAY);
        ...
        cNoFactura.setBackgroundColor(BaseColor.GRAY);
        ...
        cSubtotalUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        cIvaUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        cTotalUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        cTotales.setBackgroundColor(BaseColor.GRAY);
        ...
        cTotalColocados.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumSubtotal.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumIva.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumTotal.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumSubtotalUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumIvaUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        cSumTotalUDI.setBackgroundColor(BaseColor.GRAY);
        ...
        Image firmas = Image.getInstance("/run/media/Centos/Storage/SCOPA/imagenes/srPago.png");
