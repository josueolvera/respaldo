...
public class BuildPdfImpro {
    ...
    public void createPdf(String filename, PdfAternaPojo aternaPojo)
        ...
        font5.setSize(6f);
        font5.setColor(BaseColor.DARK_GRAY);
        ...
        paragraph4.add("INTERPROTECCION - CANAL DE PAGO");
        ...
        Image image = Image.getInstance("/run/media/Centos/Storage/SCOPA/imagenes/logoImpro.jpg");
        ...
        cProducto.setBackgroundColor(BaseColor.BLACK);
        ...
        cEmision.setBackgroundColor(BaseColor.BLACK);
        ...
        cMes.setBackgroundColor(BaseColor.BLACK);
        ...
        cSubtotal.setBackgroundColor(BaseColor.BLACK);
        ...
        cIva.setBackgroundColor(BaseColor.BLACK);
        ...
        cTotal.setBackgroundColor(BaseColor.BLACK);
        ...
        cNoFactura.setBackgroundColor(BaseColor.BLACK);
        ...
        cSubtotalUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        cIvaUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        cTotalUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        cTotales.setBackgroundColor(BaseColor.BLACK);
        ...
        cTotalColocados.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumSubtotal.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumIva.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumTotal.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumSubtotalUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumIvaUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        cSumTotalUDI.setBackgroundColor(BaseColor.BLACK);
        ...
        Image firmas = Image.getInstance("/run/media/Centos/Storage/SCOPA/imagenes/firmasInterporteccion.png");
