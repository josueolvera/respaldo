...
//            Cell name = currentRow.getCell(2);
            ...
            if (code != null) {
                ...
                Outsourcing outsourcing = outsourcingDao.finfByidEmployee(
                        ...
                        LocalDateTime.parse(calculateDate + " 05:00", formatter)
                );
                if (outsourcing != null) {
                    ...
                    outsourcing.setApplicationDate(LocalDateTime.parse(calculateDate + " 05:00", formatter));
                    ...
                    outsourcing1.setApplicationDate(LocalDateTime.parse(calculateDate + " 05:00", formatter));
        ...
        for (int i = 7; i <= sheet.getLastRowNum(); i++) {
            ...
            if (code != null) {
                ...
                if (outsourcingExits == null) {
                    ...
                    outsourcingExits.setApplicationDate(LocalDateTime.parse(calculateDate + " 05:00", formatter));
